...
if( isset($product_gallery['title']) || isset($product_gallery['images']) || isset($product_gallery['description']) ){ ?>
        ...
        <div class="row" data-aos="custom-fade-up">
            <div class="col-12">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item" id="step<?php echo $key+1; ?>">
        ...
        <div class="row" data-aos="custom-fade-up">
            <div class="col-12 d-flex justify-content-between mb-4">
                <div class="title text-16">
                    <h2 class="h3">Related Projects</h2><a href="<?php echo get_permalink(10); ?>" class="view-all text-16 fw-medium">View All Projects</a>
                </div>
                <div id="arrows"></div>
            </div>
